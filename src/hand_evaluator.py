...
class HandEvaluator:
    ...
    def evaluate_hand(cards: List[Card]) -> Tuple[str, List[int]]:
        ...
        if len(cards) == 5:
            ...
            for combo in combinations(cards, 5):
                ...
                if hand_rank > best_rank or (hand_rank == best_rank and kickers > best_hand[1]):
    ...
    @staticmethod
    def compare_hands(hand1: Tuple[str, List[int]], hand2: Tuple[str, List[int]]) -> int:
        """
        Compare two hands.
    ...
    @staticmethod
    def get_best_hand(player_cards: List[Card], community_cards: List[Card]) -> Tuple[str, List[int], List[Card]]:
        """
