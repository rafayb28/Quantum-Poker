...
class GameSession:
    ...
    def can_join(self, token: str) -> bool:
        ...
        return (
            ...
            len(self.player_tokens) < self.max_players and
            token not in self.player_tokens
        )
...
class SessionManager:
    ...
    def create_game_session(self, game_id: str, creator_token: str, max_players: int = 6) -> bool:
        """
