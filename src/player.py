class Player:
    def __init__(self, name, number, starting_chips=1000, starting_quantum_chips=5):
        self.name = name
        self.number = number
        self.hand = []
    ...
    def to_dict(self, reveal_cards: bool = False):
        ...
        return {
            ...
            "folded": self.folded,
            "all_in": self.all_in,
            "hand": [{"suit": card.suit, "rank": card.rank} for card in self.hand] if reveal_cards else None
        }
